...
// API setup
const GOOGLE_API_KEY = "AIzaSyClM26iYBexAMJrPVVB6ScWJcda4b029Tw";
...
// Function to create msg elements
...
document.addEventListener('click', ({ target }) => {
    ...
    const shouldHide = target.classList.contains("prompt-input") || (wrapper.classList.contains
        ("hide-controlls") && (target.id === "add-file-btn" || target.id === "stop-response.btn"));
